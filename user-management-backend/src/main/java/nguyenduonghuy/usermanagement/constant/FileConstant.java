...
public class FileConstant {
	public static final String USER_IMAGE_PATH = "api/users/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/api/users/";
    public static final String DIRECTORY_CREATED = "Created directory for: ";
    public static final String DEFAULT_USER_IMAGE_PATH = "api/users/image/profile/";
